...
def exportAllSesG2():
    ...
    try:
        ...
        pass
    pathInfo1 = "%s/FSUBTEST/2/NGFileMap.txt" % params.JADER_OUT
    pathIn1 = "%s/JADER.txt" % (params.JADER_OUT)
...
def mergeG2():
    fin = open("%s/FSUBTEST/2/NGFileMap.txt" % params.JADER_OUT)
    fout = open("%s/FSUBTEST/2/NG2.txt" % params.JADER_OUT, "w")
    dDrug2Se = dict()
...
def exportPolyGJADER():
    ...
    fin = open("%s/FSUBTEST/2/NG2.txt" % params.JADER_OUT)
    fout = open("%s/FSUBTEST/2/NGJADERDDI.txt" % params.JADER_OUT, "w")
